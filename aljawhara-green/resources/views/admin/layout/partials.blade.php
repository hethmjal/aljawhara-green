...
<html dir="rtl" lang="ar">
  <head>
    ...
    <title class="title">Aljawhara green </title>
    <link rel="shortcut icon" class="link" href="{{asset('front/img/bg-img/bg.png')}}" type="image/x-icon">
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{route('dashboard')}}" class="brand-link">
      <img src="{{asset('front/img/bg-img/bg.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Aljawhara green </span>
    </a>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="#" class="nav-link @if(request()->routeis('services') || request()->routeis('service.add')  || request()->routeis('service.edit')) active @endif">
          ...
          <li class="nav-item ">
            ...
            <a href="{{route('dashboard.messages')}}" class="nav-link @if(request()->routeis('dashboard.messages')||request()->routeis('dashboard.show-messages')) active @endif">
              ...
              <p> الرسائل الواردة من  تواصل معنا </p>
            </a>
          </li>
        </ul>
      </nav>
